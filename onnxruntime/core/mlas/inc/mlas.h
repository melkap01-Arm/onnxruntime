...
struct MLAS_FP8_GEMM_DATA_PARAMS {
    ...
    size_t lda = 0;
    const float* AFloat = nullptr;  // Original FP32 A for backends that quantize while packing LHS.
    const void* B = nullptr;
    size_t ldb = 0;
    const void* PackedB = nullptr;
    void* C = nullptr;
    size_t ldc = 0;
    ...
    const float* PackedScaleB = nullptr;  // Backend-specific packed B scales.
